...
command = "unzip -o " + dirname(snakemake.input.trimmed) + "/\"" + snakemake.wildcards.sample +  "*fastqc.zip\"" + " -d " + dirname(snakemake.output.summary) + "/" + snakemake.wildcards.sample + "_zip_folder"
f = open(log_filename, "at")
f.write("\n##\n## COMMAND: " + command + "\n")
f.close()
shell(command)
